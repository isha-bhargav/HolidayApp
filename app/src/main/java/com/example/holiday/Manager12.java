...
public class Manager12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manager12);
                            ...
                            .addOnCompleteListener(Manager12.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(Manager12.this, "registration successful..Now please log in", Toast.LENGTH_SHORT).show();
                                    } else {
                                        Toast.makeText(Manager12.this, "registration failed", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }else
